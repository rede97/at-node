...
#if FEATURE_BLE
/* BLE runtime switch: disable stops advertising (NimBLE stays up for fast
 * re-enable). Runtime-only, NOT persisted; ble.auto is the NVS-persisted
 * boot-time default (enable = auto at boot). */
